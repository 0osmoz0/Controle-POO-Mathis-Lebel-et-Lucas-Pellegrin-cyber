...
/**
 * Génère des one-liners / stubs agent (reverse shell, etc.) pour déploiement.
 * Target = IP et port du listener où l'agent doit se connecter.
 */
public class AgentStubGenerator implements Module {
    ...
    /**
     * Génère uniquement un one-liner bash et le retourne.
     */
    ...
    /**
     * Génère uniquement un one-liner PowerShell et le retourne.
     */
